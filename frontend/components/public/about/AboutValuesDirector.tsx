...
const VALUES = [
  { label: 'Knowledge (Ilm)', Icon: BookOpen },
  { label: 'Action (Amal)', Icon: Sparkles },
  { label: "Advocacy (Da'wah)", Icon: Megaphone },
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-y-8 gap-x-[clamp(1.5rem,3vw,3.6rem)]">
            ...
            <div className="md:w-[192px] shrink-0">
              ...
              <p className="mt-2 text-[#3F4941] leading-[1.45] text-[1rem]">
                The pillars that uphold our educational philosophy.
              </p>
            </div>
        ...
        <div className="max-w-[1280px] mx-auto sm:rounded-[28px] bg-[#048ED6] p-[clamp(1.5rem,3.3vw,4rem)]">
          <div className="rounded-[20px] bg-white px-[clamp(1.5rem,3.1vw,3.7rem)] py-[clamp(2rem,3.4vw,4rem)]">
            <div className="grid grid-cols-1 md:grid-cols-[minmax(0,256px)_minmax(0,1fr)] gap-y-10 gap-x-[clamp(2rem,4.2vw,5rem)]">
              ...
              {/* Quote */}
              <div>
                <svg viewBox="0 0 43 30" className="w-[clamp(1.75rem,2.2vw,2.7rem)] h-auto fill-[#048ED6]" aria-hidden>
                ...
                <div className="mt-[clamp(1rem,1.6vw,1.9rem)] flex flex-col gap-[clamp(1rem,1.5vw,1.8rem)] text-[#3F4941] leading-[1.86] text-[clamp(0.8125rem,0.73vw,0.875rem)]">
                  <p>
                    Welcome to Yahaya International. When we established this institution in 2020,
                    our goal was simple yet profound: to create an environment where academic rigour
                    meets spiritual depth.
                  </p>
                  <p>
                    We recognised a growing need for an educational model that does not force
                    families to choose between modern excellence and faith-based values. Here, they
                    are seamlessly integrated. Our students are challenged intellectually while
                    being supported emotionally and spiritually.
                  </p>
                  <p>
                    As you explore our community, you will find a dedicated faculty, state-of-the-art
                    facilities, and most importantly, a vibrant student body eager to learn, practise
