      ...
      <Container>
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 w-full relative">
            <div className="relative overflow-hidden shadow-xl h-[360px]">
              {/* Placeholder Image */}
              <div 
                className="absolute inset-0 bg-cover bg-center"
                style={{ backgroundImage: 'url("/images/figma-home/17.png")' }}
              />
            </div>
            
            {/* Floating Info Card */}
            <div className="absolute -bottom-6 -left-6 right-4 bg-[#048ED6] p-4 rounded shadow-xl flex items-center gap-4 text-white">
